...
export class PersonService {
  ...
  genUsername(): string {
    ...
    // For some reason ł needs to be targeted individually outside normalize - some people say that it is not diacritic
    tpn = tpn.normalize("NFD").replace(/[\u0300-\u036f]/g, "");
    tpn = tpn.replace(/\u0142/g, "l");                          // ł -> l replacer
    tpn = tpn.replace(/\u0141/g, "L");                          // Ł -> L replacer (uppercase)

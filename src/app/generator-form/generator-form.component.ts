...
export class GeneratorFormComponent implements OnInit {
  ...
  generatorForm = this.fb.group ({
    ...
    jobPL: this.person.jobPL,
    jobEN: this.person.jobEN,
